...
class DoctorNotificationsScreen extends BaseScreenView<DoctorNotificationsController> {
  const DoctorNotificationsScreen({super.key});

  static const String notificationsScreen = '/doctor-notifications';
  ...
  Widget buildView(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppCustomAppBar(
        ...
        action: GetBuilder<DoctorNotificationsController>(
          id: DoctorNotificationsController.listId,
          builder: (controller) {
      ...
      body: SafeArea(
        bottom: false,
        child: GetBuilder<DoctorNotificationsController>(
          id: DoctorNotificationsController.contentId,
          builder: (controller) {
            if (controller.isLoading) {
              return const Center(child: CircularProgressIndicator());
            }

            return GetBuilder<DoctorNotificationsController>(
              id: DoctorNotificationsController.listId,
              builder: (controller) {
                if (controller.isEmpty) {
                  return GetBuilder<DoctorNotificationsController>(
                    id: DoctorNotificationsController.emptyStateId,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'You\'ll see notifications about appointments here',
  ...
  Widget _buildNotificationItem(
    ...
    DoctorNotificationsController controller,
    bool isDark,
  ) {
