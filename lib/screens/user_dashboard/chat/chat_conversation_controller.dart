...
class UserChatConversationController extends BaseController {
  ...
  UserChatConversationController(this._chatRepository, this._storageService);

  @override
  void onInit() {
    super.onInit();
    // Track screen view
    trackScreenView('user_chat_conversation_screen');
        ...
        .listen(
          ...
          onError: (error) {
            log(
              ...
              name: 'UserChatConversationController',
            );
          },
        );
  }
  ...
  Future<void> sendMessage() async {
    ...
    try {
      ...
      log('Error sending message: $e', name: 'UserChatConversationController');
    }
  }
