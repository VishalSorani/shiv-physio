...
class UserChatConversationScreen
    extends BaseScreenView<UserChatConversationController> {
  static const String chatConversationScreen = '/user-chat-conversation';

  const UserChatConversationScreen({super.key});
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            // Messages List
            Expanded(
              child: GetBuilder<UserChatConversationController>(
                id: UserChatConversationController.messageListId,
                builder: (controller) {
  ...
  PreferredSizeWidget _buildAppBar(
    ...
    UserChatConversationController controller,
    bool isDark,
  ) {
      ...
      child: SafeArea(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: GetBuilder<UserChatConversationController>(
                id: UserChatConversationController.inputFieldId,
                builder: (controller) {
                  return TextField(
            ...
            const SizedBox(width: AppConstants.spacing2),
            // Send button
            GetBuilder<UserChatConversationController>(
              id: UserChatConversationController.sendButtonId,
              builder: (controller) {
