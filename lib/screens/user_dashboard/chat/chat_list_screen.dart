...
class UserChatListScreen extends BaseScreenView<UserChatListController> {
  static const String chatListScreen = '/user-chat-list';
  ...
  Widget buildView(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppCustomAppBar(title: 'Messages', centerTitle: true),
      body: SafeArea(
        bottom: false,
        child: GetBuilder<UserChatListController>(
          id: UserChatListController.conversationListId,
          builder: (controller) {
            if (controller.isEmpty) {
              return GetBuilder<UserChatListController>(
                id: UserChatListController.emptyStateId,
  ...
  Widget _buildConversationItem(
    ...
    UserChatListController controller,
