                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: controller.clinicHighlights.length,
                              itemBuilder: (context, index) {
                                final highlight =
                                    controller.clinicHighlights[index];
                                return AppCarouselCard(
                                  imageUrl: highlight['imageUrl'] as String,
                                  title: highlight['title'] as String,
                                  badge: highlight['badge'] as String?,
                                  badgeColor: highlight['badgeColor'] as Color?,
