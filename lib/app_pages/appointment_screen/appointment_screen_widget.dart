...
class AppointmentScreenWidget extends StatefulWidget {
  const AppointmentScreenWidget({super.key});
                                ...
                                children: [
                                  ...
                                  Align(
                                    ...
                                    child: Container(
                                      ...
                                      child: FlutterFlowDropDown<String>(
                                        controller: _model
                                                .appointmentTypeDropDownValueController ??=
                                            FormFieldController<String>(null),
                                        options: _model.appointmentDetails,
                                        onChanged: (val) => safeSetState(() =>
                                            _model.appointmentTypeDropDownValue =
                                                val),
                                        width: 200.0,
                                        height: 40.0,
                                  ...
                                  Container(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: TextFormField(
                                        ...
                                        focusNode:
                                            _model.reasonTextFieldFocusNode,
                                        autofocus: false,
                                        obscureText: false,
                                  ...
                                  Container(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.otherTextFieldTextController,
                                        focusNode:
                                            _model.otherTextFieldFocusNode,
                                        autofocus: false,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          isDense: false,
                                          ...
                                          hintText:
                                              'Any special requirement or note?',
                                          hintStyle:
                                              FlutterFlowTheme.of(context)
                                                  .labelMedium
                                                  .override(
                          ...
                          Align(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (_model.appointmentTypeDropDownValue ==
                                    null) {
                                  ScaffoldMessenger.of(context)
                                      .clearSnackBars();
